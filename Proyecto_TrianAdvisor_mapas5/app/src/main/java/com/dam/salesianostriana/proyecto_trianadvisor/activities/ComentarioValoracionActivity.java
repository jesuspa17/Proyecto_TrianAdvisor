...
public class ComentarioValoracionActivity extends AppCompatActivity {
    ...
    private class AlmacenarComentario extends AsyncTask<NuevoComentario, Void, NuevoComentario>{

        @Override
        protected NuevoComentario doInBackground(NuevoComentario... params) {
            ...
            return nuevoComentarioResponse.body();
        }

        @Override
        protected void onPostExecute(NuevoComentario comentario) {
