...
public class ValoracionAdapter extends RecyclerView.Adapter<ValoracionAdapter.ViewHolder> {
    ...
    private List<Valoracion> lista_datos;
    Context contexto;
    ...
    public ValoracionAdapter(List<Valoracion> lista_datos) {this.lista_datos = lista_datos;}
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Valoracion valoracion_actual = lista_datos.get(position);
