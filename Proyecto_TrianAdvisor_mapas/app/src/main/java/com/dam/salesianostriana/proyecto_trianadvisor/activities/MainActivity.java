...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        //Abre el MapsActivity
         ...
         //Abre el fragment que muestra los datos de mi perfil.
            ...
            //Se la pasa al fragment el sessionToken del usuario, para alli
            //obtener los datos.
            f = new MiPerfilFragment();
            Bundle extras = new Bundle();
            extras.putString("sessionToken",sessionToken);
    ...
    private class ObtenerMisDatosTask extends AsyncTask<String, Void, Usuario>{
        ...
        protected void onPostExecute(Usuario usuario) {
            ...
            Picasso.with(MainActivity.this).load(url_imagen).placeholder(R.drawable.user).resize(100, 100).into(imageViewUsuario);
            txtUsuarioNav.setText(user);
