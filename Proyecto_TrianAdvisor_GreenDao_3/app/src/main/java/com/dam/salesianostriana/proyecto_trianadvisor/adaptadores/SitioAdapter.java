...
public class SitioAdapter extends RecyclerView.Adapter<SitioAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final SitioAdapter.ViewHolder holder, int i) {
        ...
        */
        ...
        //Comento esto xq no se como hacerlo aún con greendao
                ...
                protected void onPostExecute(Valoracion valoracion) {
                    ...
                    if (valoracion != null) {
                        ...
                        for (int i = 0; i < valoracion.getResults().size(); i++) {
                            ...
                            com.dam.salesianostriana.proyecto_trianadvisor.greendao.Valoracion val_dao = new com.dam.salesianostriana.proyecto_trianadvisor.greendao.Valoracion(objectid, val, updatedAt, sitio.getId());
                            lista_dao.add(val_dao);
                        ...
                        for(int i = 0;i<lista_dao.size();i++){
                            valoracionDao.insertOrReplace(lista_dao.get(i));
                        }
