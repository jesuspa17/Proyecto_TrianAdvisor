...
public class DetalleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            if(Utils.comprobarInternet(this)){
                ...
                final ValoracionDao valoracionDao = Utils.instanciarBD(DetalleActivity.this).getValoracionDao();
    ...
    private class ObtenerDatosDeUnSitioTask extends AsyncTask<String, Void, ResultSitio> {
        ...
        protected void onPostExecute(ResultSitio resultSitio) {
            ...
            if (resultSitio != null) {
                ...
                //Recojo los datos del sitio en variables.
    ...
    //AsyncTask que devuelve las valoraciones de un sitio dado el objectId
