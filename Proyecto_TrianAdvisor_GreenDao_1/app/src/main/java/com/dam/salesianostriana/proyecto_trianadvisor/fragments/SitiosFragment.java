            ...
            if (sitio != null) {
                    ...
                    for (int i = 0; i < sitio.getResultSitioses().size(); i++) {
                        if (sitio.getResultSitioses().get(i).getNombre() != null) {
                            ...
                            String descripcion = sitio.getResultSitioses().get(i).getDireccion();
                            ...
                            //Inserto datos en la Base de datos local.
                            com.dam.salesianostriana.proyecto_trianadvisor.greendao.Sitio
                                    sitio_green =
                                    new com.dam.salesianostriana.proyecto_trianadvisor.greendao.Sitio(objectid, nombre, direccion, telefono, descripcion, categoria, latitud, longitud, url_foto, updatedAt);
                                sitioDao.insert(sitio_green);
