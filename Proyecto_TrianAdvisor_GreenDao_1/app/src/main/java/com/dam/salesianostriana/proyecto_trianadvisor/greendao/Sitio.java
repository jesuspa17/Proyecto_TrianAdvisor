...
public class Sitio {
    ...
    public Sitio(String objectId, String nombre, String direccion, String telefono, String descripcion, String categoria, String latitud, String longitud, String url_foto, String updatedAt) {
        this.objectId = objectId;
        this.nombre = nombre;
        this.direccion = direccion;
        this.telefono = telefono;
