...
public class Usuario {
    ...
    private List<Valoracion> Valoraciones_usuario;
    ...
    public Usuario(String objectId, String nombre, String email, String username, String url_foto, String sessionToken, String updatedAt) {
        this.objectId = objectId;
        this.nombre = nombre;
        this.email = email;
        this.username = username;
    ...
    /** To-many relationship, resolved on first access (and after reset). Changes to to-many relations are not persisted, make changes to the target entity. */
    public List<Valoracion> getValoraciones_usuario() {
        if (Valoraciones_usuario == null) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            ValoracionDao targetDao = daoSession.getValoracionDao();
            List<Valoracion> Valoraciones_usuarioNew = targetDao._queryUsuario_Valoraciones_usuario(id);
            synchronized (this) {
                if(Valoraciones_usuario == null) {
                    Valoraciones_usuario = Valoraciones_usuarioNew;
                }
            }
        }
        return Valoraciones_usuario;
    }

    /** Resets a to-many relationship, making the next get call to query for a fresh result. */
    public synchronized void resetValoraciones_usuario() {
        Valoraciones_usuario = null;
    }
